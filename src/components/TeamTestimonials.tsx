            ...
            <figcaption className="flex items-start gap-2 px-6 pb-6">
              <div>
                <div className="flex items-center gap-2 font-semibold text-neutral-900">
                  Ray Mills
                  <span aria-hidden="true" className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-sky-400">
                ...
                <p className="text-sm text-neutral-600">Medical Director, Precision Wellness</p>
              </div>
            </figcaption>
          </figure>
          <figure className="overflow-hidden rounded-3xl bg-white ring-1 ring-neutral-200">
            ...
            <figcaption className="flex items-start gap-2 px-6 pb-6">
              <div>
                ...
                <p className="text-sm text-neutral-600">Performance Coach</p>
              </div>
            </figcaption>
          </figure>
        </div>
